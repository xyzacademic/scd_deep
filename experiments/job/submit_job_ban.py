...
for i, params in enumerate(variables):
    ...
    part_3 = [
        ...
        f'python train_mlp.py --aug 0 --n_classes 2 --no_bias 0 --seed {params[0]} --version {params[2][1]} --epoch 200 '
        f'--target {params[2][0]}_{params[1][0]}{params[1][1]}_{"mlpbceban"}_{params[0]} --save --batch-size 200 '
        f'--dataset {params[2][0]} --c0 {params[1][0]} --c1 {params[1][1]} --lr 0.01 \n'
