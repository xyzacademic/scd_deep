...
for i in range(10):
    ...
    part_3 = [
        ...
        'python train_hinge.py --nrows 0.75 --nfeatures 1 --w-inc 0.05 --num-iters 1000 --b-ratio 0.2 \
        --updated-features 128 --round 1 --interval 10 --gpu 0  --save --n_classes 2 --iters 1 \
        --target cifar10_hinge_%d.pkl --dataset cifar10  --seed 2018 --c %.1f\n' % (variable_1, variable_2),
        ...
        --train-size 200 --target cifar10_hinge_%d --random-sign 1 --seed $seed --dataset cifar10 \
