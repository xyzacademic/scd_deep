...
python train_cnn01.py --nrows 0.75 --localit 1 --updated_conv_features 32 --updated_fc_features 128 --updated_fc_nodes 1 --updated_conv_nodes 1 --width 100 --normalize 1 --percentile 1 --fail_count 1 --loss bce --act sign --fc_diversity 1 --init normal --no_bias 1 --scale 1 --w-inc1 0.17 --w-inc2 0.2 --version fc --seed 26 --iters 1000 --dataset cifar10 --n_classes 2 --cnn 0 --divmean 1 --target cifar10_fc_sign_i1_bce_nb1_nw1_dm1_s1_fp32_32_26.pkl --updated_fc_ratio 1 --updated_conv_ratio 1
