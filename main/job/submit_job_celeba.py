...
variables = []
a = [
    'celeba_32_nr025_mlp1_sign_01loss_1000_w1_h1',
    'celeba_32_nr025_mlp2_sign_01loss_1000_w1_h1',
    'celeba_32_nr025_mlp3_sign_01loss_1000_w1_h1',
    'celeba_32_nr025_mlp4_sign_01loss_1000_w1_h1',
    # 
    # 'celeba_binary_lenet_100',
    # 'celeba_binary_lenet_100_ep1',
    # 'celeba_binary_lenet_100_ep2',
    #
    #
    # 'celeba_binary_simplenet_100',
    # 'celeba_binary_simplenet_100_ep1',
    # 'celeba_binary_simplenet_100_ep2',

    # 'celeba_binary_scd01mlp_100_br02_h500_nr075_ni25000_i1',
    # 'celeba_binary_scd01mlp_100_br02_h500_nr075_ni25000_i1_ep1.pkl',
    # 'celeba_binary_scd01mlp_100_br02_h500_nr075_ni25000_i1_ep2.pkl',
    ...
    # 'celeba_mlpbnn_approx_ep004',
    # 'celeba_mlpbnn_approx_ep1',
    # 'celeba_mlpbnn_approx_ep2',
    # 'mlp1',
# 'mlp2',
# 'mlp3',
# 'mlp4',
...
for i in range(100):
    ...
    # --target celeba_scd01mlp_1_br05_nr075_ni1000_%d.pkl --dataset celeba --version mlp --seed %d --width 1500 \
    # --metrics balanced --init normal' % (seed, seed)
        ...
        --target celeba_1_nr075_mlp1_sign_logistic_1000_%d_w1_h1_005005.pkl --dataset celeba  --seed %d  \
        ...
        --b-ratio 0.2 --updated-features 128 --round 1 --interval 20 --gpu 0  --save --n_classes 2 --iters 1 --updated-nodes 1 \
        --target celeba_1_nr075_mlp1_sign_logistic_1000_%d_w1_h1.pkl --dataset celeba  --seed %d --act sign \
