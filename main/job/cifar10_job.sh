...
--target cifar10_scdcemlp_100_br02_h20_nr075_ni1000_i1_nf1_ns06.pkl --dataset cifar10 --version ce --seed 0 --width 10000 \
--metrics balanced --init normal  --updated-nodes 1

python train_scd4.py --nrows 0.75 --nfeatures 1 --w-inc1 0.17 --w-inc2 0.2 --hidden-nodes 20 --num-iters 1000 \
--b-ratio 0.2 --updated-features 128 --round 100 --interval 20 --n-jobs 4 --num-gpus 4  --save --n_classes 2 --iters 1 \
--target cifar10_scd01mlp_100_br02_h20_nr075_ni1000_i1_nf1_ns06.pkl --dataset cifar10 --version mlp \
--seed 0 --width 10000 --metrics balanced --init normal  --updated-nodes 1 --n-samples 0.6
#
##
