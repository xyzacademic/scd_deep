...
for i in acts:
    for j in nbs:
        for k in dms:
            for m in seeds:
                if not os.path.exists(os.path.join('../checkpoints/pt', f'cifar10_toy2_{i}_i1_mce_nb{j}_nw0_dm{k}_s2_fp32_32_{m}.pt')):
...
for i, params in enumerate(variables):
    ...
    part_3 = [
        ...
        'python train_cnn01_ce.py --nrows 0.03 --localit 1 '
        ...
        f'--w-inc1 0.3 --w-inc2 0.2 --version toy2 --seed {params[3]} --iters 20000 '
        f'--dataset cifar10 --n_classes 10 --cnn 1 --divmean {params[2]} '
        f'--target cifar10_toy2_{params[0]}_i1_mce_nb{params[1]}_nw0_dm{params[2]}_s2_fp32_32_{params[3]}.pkl '
